:: ################################################################################################################
:: # symfony-project-template - Windows - Docker-compose - Start QA containers                                    #
...
TITLE symfony-project-template Containers - Rebuild the QA container set.
...
ECHO.
ECHO -----------------------------------------------------------------------
ECHO QA symfony-project-template containers successfully started.
ECHO -----------------------------------------------------------------------
