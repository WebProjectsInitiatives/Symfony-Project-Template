...
TITLE symfony-project-template Containers - Rebuild the whole container set.
...
ECHO.
ECHO -----------------------------------------------------------------------
ECHO Starting symfony-project-template PRODUCTION (prod) containers
...
ECHO.
ECHO -----------------------------------------------------------------------
ECHO Starting symfony-project-template QA (qa) containers
...
ECHO.
ECHO -----------------------------------------------------------------------
ECHO Starting symfony-project-template DEV (dev) containers
