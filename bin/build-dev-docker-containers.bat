:: ################################################################################################################
:: # symfony-project-template - Windows - Docker-compose - Start DEV containers                                   #
...
TITLE symfony-project-template Containers - Rebuild the DEV container set.
...
:explain
ECHO.
ECHO Usage: build-dev-docker-containers.bat [OPTION]
ECHO Build DEV containers for all environments for this project.
ECHO.
...
ECHO -----------------------------------------------------------------------
docker volume create dev-symfony-project-template-postgresql
